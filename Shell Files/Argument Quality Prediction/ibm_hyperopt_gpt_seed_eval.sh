...
for EPOCHS in 5.0; do
    for LEARNING_RATE in 2e-4; do
        for SEED in 45 4 93 65 18 12 53 44 71 7 96 94 76 33 50 79 17; do
        printf "$SEED\n"
        DATA_DIR="../data/argument_quality/"
        BATCH_SIZE=32
        TASK_NAME='ibm'
        TARGET_LABEL='overall'
        OUTPUT_DIR="output_logs/argument_quality/gpt_seed_${TASK_NAME}_${TARGET_LABEL}_${EPOCHS}_${LEARNING_RATE}_${SEED}/"
