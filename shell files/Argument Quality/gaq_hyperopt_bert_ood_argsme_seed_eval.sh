...
for EPOCHS in 5.0; do
    for LEARNING_RATE in 2e-4; do
        for SEED in 45 4 93 65 18 12 53 44 71 7 96 94 76 33 50 79 17 38 25 3 5 73 91 49 86 57 35 80 52 62 54 42 34 98 16 78 20 82 67 39 9 88 27 69 77 21 41 74 87 60; do
            ...
            DIMENSION='deb'
            OUTPUT_DIR="output_logs/argument_quality/bert_od_ft_argsme_${DIMENSION}_seed_${TASK_NAME}_${TARGET_LABEL}_${EPOCHS}_${LEARNING_RATE}_${SEED}/"
...
for EPOCHS in 5.0; do
    for LEARNING_RATE in 2e-4; do
        for SEED in 45 4 93 65 18 12 53 44 71 7 96 94 76 33 50 79 17 38 25 3 5 73 91 49 86 57 35 80 52 62 54 42 34 98 16 78 20 82 67 39 9 88 27 69 77 21 41 74 87 60; do
            ...
            TARGET_LABEL='overall'
            DIMENSION='qa'
            OUTPUT_DIR="output_logs/argument_quality/bert_od_ft_argsme_${DIMENSION}_seed__${TASK_NAME}_${TARGET_LABEL}_${EPOCHS}_${LEARNING_RATE}_${SEED}/"
            CACHE_DIR=cache_arg_qual_gaq
