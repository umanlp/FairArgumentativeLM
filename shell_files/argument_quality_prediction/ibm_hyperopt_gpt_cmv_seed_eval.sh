...
for EPOCHS in 5.0; do
    for LEARNING_RATE in 3e-4; do
        ...
        BATCH_SIZE=32
        TASK_NAME='ibm'
        ADAPTER_DIR='output_logs/gpt_ft_cmv/clm'
        TARGET_LABEL='overall'
        OUTPUT_DIR="output_logs/argument_quality/gpt_ft_cmv_seed_${TASK_NAME}_${TARGET_LABEL}_${EPOCHS}_${LEARNING_RATE}_${SEED}/"
